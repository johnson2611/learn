...
const Mobile = () => {
  ...
  return (
    <div className="ty">
      <div className="moSection">
        <div className="Section">
          <div className="courseTitle">Mobile Application</div>
          <div className="courseText"  style={{ color: "#fff", paddingTop: "0.7rem", paddingLeft:"2rem"}}>
            Learn all you need to know to become a mobile developer
          </div>
        </div>
      </div>
