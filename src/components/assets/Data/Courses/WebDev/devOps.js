...
const Cloud = () => {
  ...
  return (
    <div className="ty">
      <div className="devopSection">
        <div className="Section">
          <div className="courseTitle"  style={{ textAlign: "justify" }}>DevOps</div>
          <div className="courseText"  style={{  paddingTop: "0.7rem", paddingLeft: "2rem" }}> 
