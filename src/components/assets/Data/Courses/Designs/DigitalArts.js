  ...
  return (
    <div className="ty">
      <div className="artSection">
        <div className="Section">
          <div
            ...
            style={{ color: "#37012a", textAlign: "justify" }}
          >
            Digital Arts and illustration
          </div>
          <div
            className="courseText"
            style={{ color: "#706904", paddingTop: "0.7rem", paddingLeft: "2rem", textAlign: "center" }}
          >
            Become an expert in Digital Art and illustration
          </div>
        </div>
      </div>
      <div className="container">
        ...
        <div>
          <li>Understanding the basics of Digital Arts and illustration.</li>
          <li>
            Learn how to style and design web pages, including layouts, fonts
            etc.
          </li>
          <li>
            Explore the fundamentals of Digital Arts and illustration to add interactivity to web
            pages.
          </li>
          <li>
