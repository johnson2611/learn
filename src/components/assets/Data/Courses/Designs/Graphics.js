    ...
    <div className="ty">
      <div className="graphSection">
        <div className="Section">
          ...
          >
            Learn all you need to know to become a Graphics Designer
          </div>
        </div>
      </div>
      <div className="container">
        ...
        <div>
          <li>Understanding the basics of Graphics.</li>
          <li>
            Learn how to style and design web pages, including layouts, fonts
            etc.
          </li>
          <li>
            Explore the fundamentals of Graphics to add interactivity to web
            pages.
          </li>
          <li>
