    ...
    <div className="ty">
      <div className="uiSection">
        <div className="Section">
          ...
          >
            Learn all you need to know to become a UI/UX Designer
          </div>
        </div>
      </div>
      <div className="container">
        ...
        <div>
          <li>Understanding the basics of UI/UX.</li>
          <li>
            Learn how to style and design web pages, including layouts, fonts
            etc.
          </li>
          <li>
            Explore the fundamentals of UI/UX to add interactivity to web
            pages.
          </li>
          <li>
