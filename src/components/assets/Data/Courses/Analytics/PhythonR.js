  ...
  return (
    <div className="ty">
      <div className="pySection">
        <div className="Section">
          <div
            ...
            style={{ color: "#fff000", textAlign: "justify" }}
          >
          ...
          >
            Learn all you need to know to become a Data Analytics
      ...
      <div className="container">
        ...
        <div>
          <li>Understanding the basics of Data Analysis.</li>
          <li>
            Learn how to style and design web pages, including layouts, fonts
            etc.
          </li>
          <li>
            Explore the fundamentals of Data Analysis to add interactivity to web
            pages.
          </li>
          <li>
