    ...
    <div className="ty">
      <div className="netSection">
        <div className="Section">
          ...
          >
            Become an expert in Network Administration
          </div>
        </div>
      </div>
      <div className="container">
        ...
        <div>
          <li>Understanding the basics of Network Administration.</li>
          <li>
            Learn how to style and design web pages, including layouts, fonts
            etc.
          </li>
          <li>
            Explore the fundamentals of Network Administration to add
