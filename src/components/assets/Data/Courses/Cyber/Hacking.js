  ...
  return (
    <div className="ty">
      <div className="cySection">
        <div className="Section">
          ...
          <div
            ...
            style={{ color: "#fff", paddingTop: "0.7rem", marginLeft: "2rem" }}
          >
            Become an expert in Cybersecurity and Ethical Hacking
          </div>
        </div>
      </div>
      <div className="container">
        ...
        <div>
          <li>Understanding the basics of Cybersecurity and Ethical Hacking.</li>
          <li>
            Learn how to style and design web pages, including layouts, fonts
            etc.
          </li>
          <li>
            Explore the fundamentals of Cybersecurity and Ethical Hacking to add
