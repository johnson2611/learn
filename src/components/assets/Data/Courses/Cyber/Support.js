    ...
    <div className="ty">
      <div className="trSection">
        <div className="Section">
          ...
          >
            Become an expert in IT Support and Troubleshooting
          </div>
        </div>
      </div>
      <div className="container">
        ...
        <div>
          <li>Understanding the basics of IT Support and Troubleshooting.</li>
          <li>
            Learn how to style and design web pages, including layouts, fonts
            etc.
          </li>
          <li>
            Explore the fundamentals of IT Support and Troubleshooting to add
